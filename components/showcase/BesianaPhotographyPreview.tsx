...
export function BesianaPhotographyPreview({ variant = "archive" }: BesianaPhotographyPreviewProps) {
  return (
    <article className={`besiana-preview besiana-preview--${variant}`}>
      <div className="besiana-preview__copy">
        <div className="besiana-preview__eyebrow">
          <span>03 / Selected work</span>
          <span>{besianaProject.category}</span>
        </div>
        <h3>{besianaProject.title}</h3>
        <p className="besiana-preview__lead">Momente që ndihen. Fotografi që mbesin.</p>
        <p className="besiana-preview__description">{besianaProject.description}</p>
      ...
      <a className="besiana-preview__art" href={besianaProject.url} target="_blank" rel="noopener noreferrer" aria-label="Visit Besiana Photography website">
        <img
          src="/projects/besiana-photography/besiana-photography-og.jpg"
          alt="Besiana Photography website preview"
          width={1200}
          height={630}
          loading="lazy"
          decoding="async"
