...
export function activeRouteForPathname(pathname) {
  // The homepage is the identity page, not the Background route. Keep all
  // inner-route indicators inactive here so the wordmark is the only anchor.
  if (pathname === "/") return null;
  if (pathname === "/background" || pathname.startsWith("/background/")) return "background";
